...
const myBot = ['u4d7bec3a4b13fb9ff02f4bba69622eaf'];
...
=> เพลง \n\
=> ยูทูป \n\
\n\n# วิธีบิน!พิมคำว่า หวัดดีวัยรุ่น";
        var that = this;
    }
...
\n";
        ...
        if(txt === '!เสี่ยเฮียนิวสั่งบิน' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'หวัดดีวัยรุ่น' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"ผิดพลาด !");}
